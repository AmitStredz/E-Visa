...
export default function apply() {
  return (
    <div className="overflow-hidden text-black">
      <Header></Header>
      <div className="w-screen h-96 bg-bottom bg-cover" style={ {backgroundImage: `url(${img1})`}}>
      {/* <img
          src={img1}
          className="w-screen h-screen object-bottom top-0 left-0 -z-10"
        ></img> */}
      </div>
          ...
          <form action="#" method="POST" className="w-2/5 gap-3">
            ...
            <div class="mb-4">
              ...
              <input
                ...
                class="mt-1 block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm cursor-pointer"
                required
              />
            </div>
            {/* <!-- Submit Buttons --> */}
